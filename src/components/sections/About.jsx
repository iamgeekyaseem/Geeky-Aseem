        ...
        <div className="grid grid-row-1 md:grid-row-2 gap-6 mt-8">
          <div className="p-6 rounded-xl border-white/10 border hover:translate-y-1 transition-all">
            ...
            <ul className="list-disc list-inside text-gray-300 space-y-2">
              <li>
                <strong>B.Tech in Biotechnology</strong> - National Institute of
                Technology Andhra Pradesh (Dec. 2021– Aug. 2025)
              </li>
              <li>
                Relevant Coursework:{" "}
                <strong>
              ...
              <div>
                ...
                <p>
                  <ul className="list-disc list-inside text-gray-300 space-y-2">
                    ...
                    <li>
                      Applied YOLOv5 algorithm & custom-trained model using 500+
                      microscopic images.
                    </li>
                    <li>
                      Improved accuracy to 94% by integrating a noise reduction
                      function to remove background interference and implemented
                      image scaling to enhance feature detection efficiency
                    </li>
                  </ul>
                </p>
              </div>
